...
election_data = os.path.join(pathlib.Path(__file__).parent.resolve(), "Resources", "test_election_data.csv")
...
with open('analysis.txt', 'w') as f:
    ...
    f.write("----------------\n")
    for i in range(len(candidates)):
        f.write(f"{candidates}: {percent_votes}% ({num_votes})\n")   #??? I know I did this wrong
    f.write("----------------\n")
